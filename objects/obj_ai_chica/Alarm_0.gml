...
if(obj_ai_chica.ai_level >= _move) {
	...
	if(obj_ai_chica.current_camera == "RightWindow")  {
		_forward = !obj_gameplaycontroller_client.gameplay.right_door;
		if(_forward) {
	...
	if( scr_camera_is_camera_up() && obj_gameplaycontroller_client.gameplay.current_camera == obj_ai_chica.current_camera) obj_camera_current_spr.disable_camera();
