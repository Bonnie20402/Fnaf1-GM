...
self.active = obj_core.gameplay.camera.current_camera == camera_button;
...
if (!obj_core.gameplay.camera.camera_up) return;
// cant click same camera
if (obj_core.gameplay.camera.camera_up && !obj_hitbox_camera.camera_lock && obj_core.gameplay.camera.current_camera == self.camera_button) return;
