...
if(obj_core_gameplay.gameplay.jumpscared ) return;
...
#region Hover event
if(!ui_lock && mouse_in) {
	if(obj_core_gameplay.gameplay.jumpscared || obj_night.current_power == 0) return;
	camera_lock = true;
	ui_lock = true;
	obj_core_gameplay.gameplay.camera_up = !obj_core_gameplay.gameplay.camera_up;
}
