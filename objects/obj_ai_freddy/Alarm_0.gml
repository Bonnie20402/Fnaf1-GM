...
if(obj_ai_freddy.current_camera == "4B" && obj_core.gameplay.camera.current_camera == "4B") return;
...
if(obj_ai_freddy.ai_level >= _move) {
	...
	if(obj_core.gameplay.camera.camera_up && current_camera != "4B") return;
	...
	if(obj_ai_freddy.current_camera == "4B")  {
		if(obj_core.gameplay.right_door) obj_ai_freddy.current_camera = "AttackFail";
		else if(obj_core.gameplay.camera.camera_up && obj_core.gameplay.camera.current_camera != "4B") {
