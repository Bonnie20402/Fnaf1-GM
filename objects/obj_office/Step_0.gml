...
if(obj_night.current_power <= 0 || obj_gameplaycontroller_client.gameplay.jumpscared) return;
...
if(!obj_gameplaycontroller_client.gameplay.left_light && !obj_gameplaycontroller_client.gameplay.right_light) {
	_sprite = spr_office;
	
}
if (obj_gameplaycontroller_client.gameplay.left_light ) {
	_sprite = obj_gameplaycontroller_client.gameplay.light_flickering ? spr_office : _left_light_sprite;
}

if (obj_gameplaycontroller_client.gameplay.right_light ) {
	//TODO: Change when adding animatronics!
	_sprite = obj_gameplaycontroller_client.gameplay.light_flickering ? spr_office : _right_light_sprite;
}
