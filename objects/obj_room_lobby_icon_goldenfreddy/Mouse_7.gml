...
if (obj_lobby_client.lobby_master == obj_fnafguard_client.client_id) {
    if (obj_lobby_client.lobby_gameplay_settings != undefined) {
        var _toggle = !obj_lobby_client.lobby_gameplay_settings.golden_freddy_enabled;
        var _settings_update = new GameplaySettingsUpdate(GAMEPLAYSETTINGS.GOLDEN_FREDDY_ENABLED, _toggle);
