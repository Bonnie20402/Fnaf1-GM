...
on_server_message_recieved = function(_message_type,_message) {
	...
	if(_message_type == FNAFMESSAGE_FROM_SERVER.LOBBY_GAMEPLAYSETTINGS_UPDATE) {
		obj_lobby_client.update_gameplay_settings(_message);
	}
	#endregion
	...
	if(_message_type == FNAFMESSAGE_FROM_SERVER.GAMEPLAY_UPDATE) {
		obj_spectate_client.update_gameplay(json_parse(_message));
	}
	#endregion
