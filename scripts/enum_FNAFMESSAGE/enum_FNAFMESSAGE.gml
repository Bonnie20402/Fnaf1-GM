...
enum FNAFMESSAGE_FROM_CLIENT {
	...
	LOBBY_JOIN_REQUEST = 118,
	LOBBY_STARTMATCH_REQUEST = 119, // Uses Lobby Response
	LOBBY_KICK_REQUEST = 120
}
...
enum FNAFMESSAGE_FROM_SERVER
{
	...
	SERVER_STATE_UPDATE = 203,
	UPDATE_ALIVE_GUARDS = 204,
	NEW_FNAF_ATTACK = 205,
	LOBBY_JOIN_RESPONSE =206,
	LOBBY_STATE_UPDATE = 207,
	LOBBY_MASTER_UPDATE = 208,
	LOBBY_STARTMATCH_RESPONSE = 209,
	LOBBY_KICK_RESPONSE = 210
}
